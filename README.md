...
Further, there are the intention to use uv (for python) and rv (for R) as package managers frameworks according to the project, to manage required dependencies when working with both languages. 